...
from .views import  get_exercises_with_avoid_flag_by_muscle, list_exercises, recommend_program_ai, search_exercises ,make_program , get_program ,delete_program , update_program , get_coach_programs, update_program_by_days,get_exercises_with_avoid_flag
...
urlpatterns = [
   ...
   path("avoidexercisesbymuscle/<int:user_id>/", get_exercises_with_avoid_flag_by_muscle, name='avoided exercises by muscle'),
]