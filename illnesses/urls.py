...
from .views import get_exercises_to_avoid_for_user, get_foods_to_avoid_for_user, list_illnesses,add_illnisses_list,add_illnisses_exercises_list,list_illnesses_exercises,delete_all_illnesses
